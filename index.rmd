...
if(params$pdf_mode){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/muriona/cv/blob/main/muriona-cv.pdf)")
}
```
...
glue::glue('
    ...
    - <i class="fab fa-researchgate"></i> [researchgate.net/Mauricio-Uriona-Maldonado](https://www.researchgate.net/profile/Mauricio-Uriona-Maldonado-2)
  ')
```
